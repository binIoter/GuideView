 ...
 * {@link com.demo.guide.Component},设置文字或者图片等
 * {@link com.demo.guide.Component#getView(android.view.LayoutInflater)}
 * . 所有的图片文字都是相对于targetRect来定义的。可以设定额外的x，
 * {@link com.demo.guide.Component#getXOffset()} ;y偏移量,
 * {@link com.demo.guide.Component#getYOffset()}。
 * </p>
 * <p>
...
public class GuideBuilder {
     ...
     * 设置遮罩可见状态变化时的监听回调
     *
     * @param onVisibilityChangedListener
     * @return
     */
